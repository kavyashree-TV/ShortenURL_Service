...
ActiveRecord::Schema.define(version: 20200814105508) do

  create_table "shorten_urls", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci" do |t|
    t.text "original_url"
